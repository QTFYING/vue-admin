declare module 'vue' {
  ...
  export interface GlobalComponents {
    IconifyIconOffline: (typeof import('../src/components/re-icon'))['IconifyIconOffline'];
    IconifyIconOnline: (typeof import('../src/components/re-icon'))['IconifyIconOnline'];
    FontIcon: (typeof import('../src/components/re-icon'))['FontIcon'];
    Auth: (typeof import('../src/components/re-auth'))['Auth'];
    Perms: (typeof import('../src/components/re-perms'))['Perms'];
  }
}
