declare module 'vue' {
  ...
  export interface GlobalComponents {
    IconifyIconOffline: (typeof import('../src/components/re_Icon'))['IconifyIconOffline'];
    IconifyIconOnline: (typeof import('../src/components/re_Icon'))['IconifyIconOnline'];
    FontIcon: (typeof import('../src/components/re_Icon'))['FontIcon'];
    Auth: (typeof import('../src/components/re_auth'))['Auth'];
    Perms: (typeof import('../src/components/re_perms'))['Perms'];
  }
}
